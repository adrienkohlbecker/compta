      ...
      CREATE OR REPLACE VIEW view_euro_fund_interest_filled AS
        ...
        t_interest_rates AS (
          SELECT
        	...
        	COALESCE(interest_rates.served_rate, interest_rates.minimal_rate) * (1 - interest_rates.social_tax_rate) AS rate_for_computation
          FROM interest_rates
        ...
        t_interest_rates_filled AS (
          ...
          UNION (
        	...
        	(t_interest_rates.from + '1 year'::interval)::date,
        	(t_interest_rates.to + '1 year'::interval)::date,
